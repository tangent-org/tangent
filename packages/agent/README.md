...
```typescript
declare module "@tangent-ai/tangent-agent-core" {
...
```typescript
import { Agent, streamProxy } from "@tangent-ai/tangent-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@tangent-ai/tangent-agent-core";
