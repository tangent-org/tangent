 ...
 *
 * Existing apps switch imports from "@tangent-ai/tangent-ai" to
 * "@tangent-ai/tangent-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@tangent-ai/tangent-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@tangent-ai/tangent-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@tangent-ai/tangent-ai/providers/all" or `Models.getProviders()`. */
