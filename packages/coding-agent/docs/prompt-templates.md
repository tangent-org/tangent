> tangent can create prompt templates. Ask it to build one for your workflow.
...
- Global: `~/.tangent/agent/prompts/*.md`
- Project: `.pi/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `tangent.prompts` entries in `package.json`
