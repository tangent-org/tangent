> tangent can create TUI components. Ask it to build one for your use case.

# TUI Components

Extensions and custom tools can render custom TUI components for interactive user interfaces. This page covers the component system and available building blocks.

**Source:** [`@tangent-ai/tangent-tui`](https://github.com/earendil-works/tangent/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@tangent-ai/tangent-tui";
...
```typescript
import { Container, type Focusable, Input } from "@tangent-ai/tangent-tui";
...
Import from `@tangent-ai/tangent-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@tangent-ai/tangent-tui";
```
...
```typescript
import { matchesKey, Key } from "@tangent-ai/tangent-tui";
...
```typescript
import { MouseRegion } from "@tangent-ai/tangent-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@tangent-ai/tangent-tui";
...
```typescript
import { getMarkdownTheme } from "@tangent-ai/tangent-coding-agent";
import { Markdown } from "@tangent-ai/tangent-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@tangent-ai/tangent-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@tangent-ai/tangent-coding-agent";
import { DynamicBorder } from "@tangent-ai/tangent-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@tangent-ai/tangent-tui";
...
```typescript
import { BorderedLoader } from "@tangent-ai/tangent-coding-agent";

tangent.registerCommand("fetch", {
  handler: async (_args, ctx) => {
    const result = await ctx.ui.custom<string | null>((tui, theme, _kb, done) => {
...
For toggling multiple settings. Use `SettingsList` from `@tangent-ai/tangent-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@tangent-ai/tangent-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@tangent-ai/tangent-tui";

tangent.registerCommand("settings", {
  handler: async (_args, ctx) => {
...
Customize the inline working indicator shown while tangent is streaming a response.
...
// Restore tangent's default spinner
ctx.ui.setWorkingIndicator();
```
...
import { matchesKey, truncateToWidth } from "@tangent-ai/tangent-tui";
