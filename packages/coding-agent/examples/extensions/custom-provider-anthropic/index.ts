 ...
 *   tangent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... tangent -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (tangent: ExtensionAPI) {
	tangent.registerProvider("custom-anthropic", {
