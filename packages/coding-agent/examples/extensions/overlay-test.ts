 ...
 *
 * Usage: tangent --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@tangent-ai/tangent-tui";

export default function (tangent: ExtensionAPI) {
	tangent.registerCommand("overlay-test", {
