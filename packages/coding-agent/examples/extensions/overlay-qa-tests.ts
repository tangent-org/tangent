 ...
 *
 * Usage: tangent --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@tangent-ai/tangent-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@tangent-ai/tangent-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@tangent-ai/tangent-tui";
...
export default function (tangent: ExtensionAPI) {
	...
	tangent.registerCommand("overlay-animation", {
	...
	tangent.registerCommand("overlay-anchors", {
	...
	tangent.registerCommand("overlay-margins", {
	...
	tangent.registerCommand("overlay-stack", {
	...
	tangent.registerCommand("overlay-overflow", {
	...
	tangent.registerCommand("overlay-edge", {
	...
	tangent.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	tangent.registerCommand("overlay-maxheight", {
	...
	tangent.registerCommand("overlay-sidepanel", {
	...
	tangent.registerCommand("overlay-toggle", {
	...
	tangent.registerCommand("overlay-passive", {
	...
	tangent.registerCommand("overlay-focus", {
	...
	tangent.registerCommand("overlay-streaming", {
