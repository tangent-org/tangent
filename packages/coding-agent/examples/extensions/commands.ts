 ...
 * Commands Extension
 *
 * Demonstrates the tangent.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@tangent-ai/tangent-coding-agent";

export default function commandsExtension(tangent: ExtensionAPI) {
	tangent.registerCommand("commands", {
