import { uuidv7 } from "@tangent-ai/tangent-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@tangent-ai/tangent-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@tangent-ai/tangent-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@tangent-ai/tangent-tui";
...
export default function (tangent: ExtensionAPI) {
	tangent.registerCommand("summarize", {
