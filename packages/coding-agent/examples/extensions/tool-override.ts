...
import type { TextContent } from "@tangent-ai/tangent-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@tangent-ai/tangent-coding-agent";
...
export default function (tangent: ExtensionAPI) {
	...
	tangent.registerCommand("read-log", {
