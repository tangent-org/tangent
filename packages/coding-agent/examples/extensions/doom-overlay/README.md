...
Play DOOM as an overlay in tangent. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
tangent --extension ./examples/extensions/doom-overlay
```
...
- [pi-doom](https://github.com/badlogic/pi-doom) for the original tangent integration
