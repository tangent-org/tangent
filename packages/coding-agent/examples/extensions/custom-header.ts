 ...
 * (logo + keybinding hints) with a custom component showing the tangent mascot.
 */

import type { ExtensionAPI, Theme } from "@tangent-ai/tangent-coding-agent";
import { VERSION } from "@tangent-ai/tangent-coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the tangent agent character
...
export default function (tangent: ExtensionAPI) {
	...
	tangent.registerCommand("builtin-header", {
