...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/earendil-works/tangent/releases/latest`;
	}
...
export const PACKAGE_NAME: string = pkg.name || "@tangent-ai/tangent-coding-agent";
export const APP_NAME: string = piConfigName || "tangent";
export const APP_TITLE: string = piConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".tangent";
...
// =============================================================================
// User Config Paths (~/.tangent/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.tangent/agent/) */
