...
const OFFICIAL_PACKAGE_NAME = "@tangent-ai/tangent-coding-agent";
const OFFICIAL_APP_NAME = "tangent";
const OFFICIAL_CONFIG_DIR_NAME = ".tangent";
 ...
 * - experimental features are enabled (TANGENT_EXPERIMENTAL=1)
