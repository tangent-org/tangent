...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|tangent]   Update tangent, extensions, or model catalogs
...
${chalk.bold("Environment Variables:")}
  ...
  PI_SHARE_VIEWER_URL              - Base URL for /share command (no default; /share disabled unless set)
