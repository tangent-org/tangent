...
import { contentText, retryDelayMs } from "@tangent-ai/tangent-ai";
import type {
	AssistantMessage,
	AuthResult,
	ImageContent,
	...
	TextContent,
	Usage,
} from "@tangent-ai/tangent-ai/compat";
import {
	clampThinkingLevel,
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via tangent.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via tangent.sendMessage()
