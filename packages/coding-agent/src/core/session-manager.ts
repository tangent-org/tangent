...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@tangent-ai/tangent-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.tangent/agent/sessions/.
 */
...
export class SessionManager {
	...
	private _setSessionFile(sessionFile: string, preloadedFileEntries?: FileEntry[]): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a tangent session, fail without modifying it.
			if (entries.length === 0) {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.tangent/agent/sessions/<encoded-cwd>/).
	 */
