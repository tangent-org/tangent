...
const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/tangent/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/earendil-works/tangent/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.tangent/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.tangent/agent/ instead of
 * ~/.tangent/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by tangent, so only warn if it has other files.
 */
