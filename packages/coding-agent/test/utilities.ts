...
import type { OAuthCredentials } from "@tangent-ai/tangent-ai";
import { getModel, streamSimple } from "@tangent-ai/tangent-ai/compat";
import { builtinProviders } from "@tangent-ai/tangent-ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.tangent/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".tangent", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.tangent/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.tangent/agent/auth.json
 */
...
/** Path to the real tangent agent config directory */
export const PI_AGENT_DIR = join(homedir(), ".tangent", "agent");

/**
 * Get an AuthStorage instance backed by ~/.tangent/agent/auth.json
