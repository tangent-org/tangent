...
import type { AssistantMessage, Context, Model } from "@tangent-ai/tangent-ai";
...
vi.mock("@tangent-ai/tangent-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@tangent-ai/tangent-ai/compat")>();
	return {
		...actual,
