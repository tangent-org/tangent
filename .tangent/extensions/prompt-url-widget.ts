...
import { DynamicBorder, type ExtensionAPI, type ExtensionContext } from "@tangent-ai/tangent-coding-agent";
import { Container, hyperlink, Text } from "@tangent-ai/tangent-tui";
