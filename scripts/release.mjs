 ...
 * 10. Push main and the tag to trigger CI publication and verified tangent.dev announcement
 */
...
console.log(`=== Prepared release v${version}; CI publication and tangent.dev announcement start after the tag push ===`);
